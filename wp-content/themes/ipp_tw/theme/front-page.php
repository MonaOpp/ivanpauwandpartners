...
?>
    ...
    ?>
        <section class="w-full bg-[#F7F2F2]">
            <div class="layout-wrapper mx-auto px-12 py-12">
                ...
                <?php if ( ! is_wp_error( $categories ) && ! empty( $categories ) ) : ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <?php foreach ( $categories as $category ) : ?>
                            ...
                            <div class="relative flex min-h-[420px] items-center justify-center bg-[#132E47] px-8 py-16 text-center text-white"
                                <?php if ( $bg_image ) : ?>
                            ...
                            >
                                ...
                                <div class="relative z-10 w-full">
                                    <h3 class="mb-6 text-5xl font-extrabold uppercase leading-tight md:text-7xl text-white ">
